...
class ofxNCoreVision : public ofxGuiListener
{
	...
	enum
	{
		...
		//CTI-ESPOL
		//Parameters to selecting how to generate points


        trackedPanel_CenterPoints,
		trackedPanel_RoundedPoints,
        trackedPanel_Dpconstant,
        trackedPanel_Polygon,
